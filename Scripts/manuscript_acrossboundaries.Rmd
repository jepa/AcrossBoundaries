...
Seasonality plays an important role in determine the spatial distribution of CPUE (Figure \@ref{fig:figInterpolation}. Specific latitudinal variations in the overall distribution is seen for all species. This is evident for scup, whose historical northern distribution limit varied from Massachusetts (latitude ~42.4) in spring to the northern coast of Maine (latitude ~44) in the fall. Such seasonality has shifted northward over the last couple of decades for both scup and black sea bass. For example, black sea bass has substantially expanded its range over the spring from and initial Northern limit at New Jersey (latitude ~$40.6^o$) to the border of Maine and New Hampshire (latitude ~$43^o$). In addition to presenting the larger latitudinal shift in CPUE centroid (i.e., the region with the highest CPUE) relative to the historical centroid, a $2.1^0$ shift in fall distribution). In the case of summer flounder, however, such latitudinal seasonality is less evident. Instead, interpolation results suggests a longitudinal (or depth) shift in the species range from a largely coastal concentration in the fall to a eastward shift in the spring. Such pattern seems to become even more pronounced in current spring distributions, realtive to historical levels.
