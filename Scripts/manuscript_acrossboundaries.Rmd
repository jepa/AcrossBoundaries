...
Seasonal differences are also evident, although smaller than regulatory unit differences, when estimate each state's CPUE proportion for all species (Figures \@ref{fig:figSeasonlDiff}). Here, half of the cases represent 1% or no seasonality difference like Connecticut's CPUE proportion of summer flounder. The largest difference are in the latitudinal extremes with Maine currently getting 4% more CPUE in the fall than in spring as opposite to Virginia who gets 4% more in the spring than in the fall. 
...
The proportion of the CPUE has increased for northern states 
