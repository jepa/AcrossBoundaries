...
grid_eez_df <-  st_read("/Volumes/Enterprise/Data/AcrossBoundaries/Data/Spatial/grid_sf/grid_eez_sf.shp") %>% 
  filter(state != "pennsylvania")

# Make sure no Penn.
unique(grid_eez_df$state)

# over write sf
write_sf(grid_eez_df, paste0(my_path("D", "Spatial"),"grid_eez_sf.shp"))
