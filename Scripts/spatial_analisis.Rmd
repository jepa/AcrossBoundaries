...
*Notes:* Panel represents the **Spring.** survey. This computation considers the Overlapping of state waters.
...
land_sf %>% 
  ...
  ggsave(filename = "proportion_chg.jpg",
...
```{r area_map, eval = T, echo = T, fig.width = 10, fig.height=6}
...
ggplot(state_fit) +
  ...
  theme(legend.key.width = unit(1,"line")) + 
  ggsave(filename = "area_plot_avg.jpg",
         plot = ggplot2::last_plot(),
         path = my_path("R","Figures"),
         width = 8,
         height = 6
